...
--
-- Host: 127.0.0.1
-- Tempo de geração: 30-Jul-2020 às 22:14
...
INSERT INTO `lives` (`id_lives`, `url`, `titulo`, `id_tv`, `data_post`, `created_at`, `updated_at`) VALUES
(1, 'uploads/lives/2020/07/thebox-1596069143.mp3', 'The Box', 1, '2020-07-29', '2020-07-30 05:32:23', '2020-07-30 05:32:23'),
(4, 'uploads/lives/2020/07/will-smith-banido-meme-1595958941-1596069537.mp4', 'True', 1, '2020-07-29', '2020-07-30 05:38:57', '2020-07-30 05:38:57');
...
--
ALTER TABLE `lives`
  MODIFY `id_lives` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
